 ...
 */
public final class ConnectionMaxTest extends JMS11WorkerThread implements WorkerThread.Paceable {
	
	private int connId = 1;
	private String connPrefix = UUID.randomUUID().toString();
     ...
     * @param name
     */
    public ConnectionMaxTest(String name) {
        super(name);
    }
	...
	public final boolean oneIteration() throws Exception {		
		//buildJMSResources();
		//System.out.println("connecting with id: "+connId);
		super.buildJMSResources(false, (connPrefix+(connId++)));
