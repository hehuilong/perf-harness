 ...
 */
public class PutGetByIdSet extends JMS11WorkerThread implements WorkerThread.Paceable, MessageListener {
    ...
    public static void registerConfig() {
		Config.registerSelf( PutGetByIdSet.class );
	}    
     ...
     * @param name
     */
    public PutGetByIdSet(String name) {
        super( name );
    }
    ...
    protected void buildJMSResources() throws Exception {
    	...
    	int nput = msgIdList.size();
		if (Config.parms.containsKey("mg")) {
			nget = Config.parms.getInt("mg");
		}
		getStep = nput/nget;
    	// build consumer
	...
	private void sendMessages(Message outMessage, List<String> msgIdList) throws JMSException, InterruptedException {
		int numToPut = 1000;
