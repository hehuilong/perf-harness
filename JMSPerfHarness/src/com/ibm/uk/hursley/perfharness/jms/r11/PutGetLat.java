 ...
 */
public final class PutGetLat extends JMS11WorkerThread implements WorkerThread.Paceable {
    ...
    public static void registerConfig() {
		Config.registerSelf( PutGetLat.class );
    ...
    public void run() {
        ...
        System.out.println("Total iteration: "+numOfIteration);
        System.out.println("Total put/get round-trip time: "+itTotalTime);
        System.out.println("Average put/get latency: "+(double)itTotalTime/(double)numOfIteration);
    } // End public void run()
